...
#ifndef VERILATED_VFPU_WALLOC_17BITS_H_
#define VERILATED_VFPU_WALLOC_17BITS_H_  // guard

#include "verilated.h"

class Vfpu__Syms;

class Vfpu_walloc_17bits final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vfpu_walloc_17bits(Vfpu__Syms* symsp, const char* v__name);
    ~Vfpu_walloc_17bits();
    VL_UNCOPYABLE(Vfpu_walloc_17bits);
