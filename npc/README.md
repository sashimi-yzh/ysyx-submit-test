...
运行riscv32e-npc功能测试环境：取消注释`#define NPC_WITHOUT_SOC 1`，否则则注释该代码
...
运行到有内容打印大概需要20min，勉强能玩贪吃蛇，打字游戏和超级玛丽太卡了，能运行但玩不了
...
如果运行iverilog，取消[NPC_cloud_SoC/rtl/npc_cloud_cpu.scala]里47行的注释
