...
module CPU(	// src/CPU.scala:33:9
  ...
  ysyx_23060170 cpu (	// src/CPU.scala:38:21
    .clock                   (clock),
    .reset                   (reset),
    ...
    .io_slave_awvalid       (),	// src/CPU.scala:35:23, :36:19, :38:21
    .io_slave_awid     (),	// src/CPU.scala:36:19, :38:21
    .io_slave_awaddr   (),	// src/CPU.scala:36:19, :38:21
    .io_slave_awlen    (),	// src/CPU.scala:36:19, :38:21
    .io_slave_awsize   (),	// src/CPU.scala:36:19, :38:21
    .io_slave_awburst  (),	// src/CPU.scala:36:19, :38:21
    .io_slave_wready        (/* unused */),
    .io_slave_wvalid        (),	// src/CPU.scala:35:23, :36:19, :38:21
    .io_slave_wdata    (),	// src/CPU.scala:36:19, :38:21
    .io_slave_wstrb    (),	// src/CPU.scala:36:19, :38:21
    .io_slave_wlast    (),	// src/CPU.scala:35:23, :36:19, :38:21
    .io_slave_bready        (),	// src/CPU.scala:35:23, :36:19, :38:21
    .io_slave_bvalid        (/* unused */),
    .io_slave_bid      (/* unused */),
    .io_slave_bresp    (/* unused */),
    .io_slave_arready       (/* unused */),
    .io_slave_arvalid       (),	// src/CPU.scala:35:23, :36:19, :38:21
    .io_slave_arid     (),	// src/CPU.scala:36:19, :38:21
    .io_slave_araddr   (),	// src/CPU.scala:36:19, :38:21
    .io_slave_arlen    (),	// src/CPU.scala:36:19, :38:21
    .io_slave_arsize   (),	// src/CPU.scala:36:19, :38:21
    .io_slave_arburst  (),	// src/CPU.scala:36:19, :38:21
    .io_slave_rready        (),	// src/CPU.scala:35:23, :36:19, :38:21
...
module AXI4SDRAM(	// src/device/SDRAM.scala:65:9
  ...
  output [13:0] sdram_bundle_a,	// src/device/SDRAM.scala:67:26
  ...
  output [1:0]  sdram_bundle_select_h
);
  ...
  sdram_top_axi msdram (	// src/device/SDRAM.scala:69:24
    ...
    .sdram_select_h (sdram_bundle_select_h)
...
module ysyxSoCASIC(	// src/SoC.scala:59:9
  ...
  AXI4SDRAM lsdram_axi (	// src/SoC.scala:48:60
    ...
    .sdram_bundle_select_h  (sdram_select_h)
  );	// src/SoC.scala:48:60
...
module ysyxSoCFull(	// src/SoC.scala:111:9
  ...
  ysyxSoCASIC asic (	// src/SoC.scala:107:24
    ...
    .sdram_dq   (_dq_wire),
    .sdram_select_h (_asic_sdram_select_h),
  ...
  reg        _asic_sdram_ras_l;
  reg        _asic_sdram_cas_l;
  reg        _asic_sdram_we_l;
  reg        _asic_sdram_ras_h;
  reg        _asic_sdram_cas_h;
  reg        _asic_sdram_we_h;
  always @(*) begin
    {_asic_sdram_ras_l, _asic_sdram_cas_l, _asic_sdram_we_l} = 3'b111;
    {_asic_sdram_ras_h, _asic_sdram_cas_h, _asic_sdram_we_h} = 3'b111;

    if (_asic_sdram_select_h[0]) begin
      {_asic_sdram_ras_l, _asic_sdram_cas_l, _asic_sdram_we_l} = 
      {_asic_sdram_ras,   _asic_sdram_cas,   _asic_sdram_we};
    end

    if (_asic_sdram_select_h[1]) begin
      {_asic_sdram_ras_h, _asic_sdram_cas_h, _asic_sdram_we_h} = 
      {_asic_sdram_ras,   _asic_sdram_cas,   _asic_sdram_we};
    end
  end
  wire [2 :0] sdram_cmd = {_asic_sdram_ras, _asic_sdram_cas, _asic_sdram_we};
  wire [13:0] _asic_sdram_a_0 = _asic_sdram_a;
  wire [13:0] _asic_sdram_a_1 = (sdram_cmd == 3'b101 || sdram_cmd == 3'b100) ? 
                         _asic_sdram_a + 14'd1 : _asic_sdram_a;
  sdram sdram_l0 (	// src/SoC.scala:145:23
    .clk (_asic_sdram_clk),	// src/SoC.scala:107:24
    .cke (_asic_sdram_cke),	// src/SoC.scala:107:24
    .cs  (_asic_sdram_cs),	// src/SoC.scala:107:24
    .ras (_asic_sdram_ras_l),	// src/SoC.scala:107:24
    .cas (_asic_sdram_cas_l),	// src/SoC.scala:107:24
    .we  (_asic_sdram_we_l),	// src/SoC.scala:107:24
    .a   (_asic_sdram_a_0),	// src/SoC.scala:107:24
    .ba  (_asic_sdram_ba),	// src/SoC.scala:107:24
    .dqm (_asic_sdram_dqm[1:0]),	// src/SoC.scala:107:24
    .dq  (_dq_wire[15:0])
  );	// src/SoC.scala:145:23
  sdram sdram_l1 (	// src/SoC.scala:145:23
    .clk (_asic_sdram_clk),	// src/SoC.scala:107:24
    .cke (_asic_sdram_cke),	// src/SoC.scala:107:24
    .cs  (_asic_sdram_cs),	// src/SoC.scala:107:24
    .ras (_asic_sdram_ras_l),	// src/SoC.scala:107:24
    .cas (_asic_sdram_cas_l),	// src/SoC.scala:107:24
    .we  (_asic_sdram_we_l),	// src/SoC.scala:107:24
    .a   (_asic_sdram_a_1),	// src/SoC.scala:107:24
    .ba  (_asic_sdram_ba),	// src/SoC.scala:107:24
    .dqm (_asic_sdram_dqm[3:2]),	// src/SoC.scala:107:24
    .dq  (_dq_wire[31:16])
  );	// src/SoC.scala:145:23
  sdram sdram_h0 (	// src/SoC.scala:145:23
    .clk (_asic_sdram_clk),	// src/SoC.scala:107:24
    .cke (_asic_sdram_cke),	// src/SoC.scala:107:24
    .cs  (_asic_sdram_cs),	// src/SoC.scala:107:24
    .ras (_asic_sdram_ras_h),	// src/SoC.scala:107:24
    .cas (_asic_sdram_cas_h),	// src/SoC.scala:107:24
    .we  (_asic_sdram_we_h),	// src/SoC.scala:107:24
    .a   (_asic_sdram_a_0),	// src/SoC.scala:107:24
    .ba  (_asic_sdram_ba),	// src/SoC.scala:107:24
    .dqm (_asic_sdram_dqm[1:0]),	// src/SoC.scala:107:24
    .dq  (_dq_wire[15:0])
  );	// src/SoC.scala:145:23
  sdram sdram_h1 (	// src/SoC.scala:145:23
    .clk (_asic_sdram_clk),	// src/SoC.scala:107:24
    .cke (_asic_sdram_cke),	// src/SoC.scala:107:24
    .cs  (_asic_sdram_cs),	// src/SoC.scala:107:24
    .ras (_asic_sdram_ras_h),	// src/SoC.scala:107:24
