...
VL_ATTR_COLD void Vbooth_wallace_multiplier_walloc_17bits___ctor_var_reset(Vbooth_wallace_multiplier_walloc_17bits* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbooth_wallace_multiplier__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vbooth_wallace_multiplier_walloc_17bits___ctor_var_reset\n"); );
    // Body
