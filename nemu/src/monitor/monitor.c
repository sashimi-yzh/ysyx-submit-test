...
char *inst_stream_file = "inst_stream.log";
...
static int parse_args(int argc, char *argv[]) {
  ...
  while ( (o = getopt_long(argc, argv, "-bhl:d:p:e:i:", table, NULL)) != -1) {
    switch (o) {
      ...
      case 'i': inst_stream_file = optarg;break;
      ...
      default:
        ...
        printf("\t-i,--inst=INST_FILE     output instruction stream FILE\n");
        printf("\n");
        exit(0);
    }
  }
...
void init_monitor(int argc, char *argv[]) {
  ...
  /* Open the log file. */
  init_log(log_file);
  printf("inst stream %s",inst_stream_file);
