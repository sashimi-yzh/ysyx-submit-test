...
static long load_img() {
  ...
  int ret = fread(get_flash_base(), size, 1, fp);
#else
...
#ifndef __ICS_EXPORT
    {"ftrace"   , required_argument, NULL,  0 },
#endif
...
#ifndef __ICS_EXPORT
      case 0: init_ftrace(optarg); break;
      case 1: img_file = optarg; return MUXDEF(CONFIG_MODE_USER, optind - 1, 0);
#else
