...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, s->dnpc=isa_raise_intr( R(17),s->pc);IFDEF(CONFIG_ETRACE,s->is_exception=1)); // R(17) is $a7, which is the syscall number
